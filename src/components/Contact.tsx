    ...
    <section id="contact" className="px-4 py-14 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="soft-card mt-6 px-5 py-8 sm:px-8 sm:py-10">
          <p className="flex items-center gap-2 text-sm font-medium text-terracotta-strong">
            <span className="live-dot inline-block h-1.5 w-1.5 rounded-full bg-terracotta-strong" aria-hidden />
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4">
            <button
              type="button"
              onClick={copyEmail}
              className="ticket-btn px-5 py-3 text-sm font-semibold"
            >
              {copied ? (
                <>
